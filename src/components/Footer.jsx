      ...
      <footer className="footer">
         ...
         <div className="footer-div">
            ...
            <svg className="mobile-icon" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
               <path
                  d="M30.6493 29.6887L26.9042 10.2882L3.0549 34L0 30.7662L23.8493 7.05488L4.43488 3.42941L7.68698 0L29.8609 4.01718L34 26.2593L30.6493 29.6887Z"
                  fill="#3C3C3B"
               />
            </svg>
         </div>
         <div className="form-budget">
            <li>
               <a href="">Developed by gigson © 2024 </a>
            </li>
         </div>
         <div className="footer-div-policy">
            <li>
               <Link to="/">Legal Policy </Link>
            </li>
            <li>
