      ...
      <main>
         <section className="div-about-hero">
            <h1 className="about-hero-h1">
               Our team is built by professionals with more than <span className="about-span-hero">9 Years</span> of experience.{" "}
            </h1>
         ...
         <section className="div-about-belive">
            ...
            <article>
               ...
               <p className="about-believe-p">
                  Regardless of whether we're crafting a proof of concept or a final product, we apply various product quality and project
                  management standards to ensure that every product meets and exceeds expectations.
               </p>
            </article>
            <article>
               <div className="div-svg-about">
               ...
               <p className="about-believe-p">
                  You'll have the flexibility to choose the level of engagement you prefer with us. We'll always be by your side to support you
                  at any stage, but if you decide not to continue, we'll handle the closure and necessary handover, complying with all current
                  legal requirements.
               </p>
            </article>
            ...
            <article>
               ...
               <p className="about-believe-p">
                  Security is essential to us. We offer the ability to audit and certify our cloud solutions with CIS, CISA, FedRAMP, PCI-DSS,
                  GDPR, FFIEC, and SOC2.
               </p>
            </article>
         </section>
         <section className="about-section-need">
            ...
            <h2 className="about-hero-need-h2">
               What do I need to build a <span className="about-span-hero">Digital product?</span>{" "}
            </h2>
            <p className="about-need-p">
               Develop a software product is much more than just building physical product or running a project. This type of products require
               full attention and knowledge in different areas to avoid costs overrun or technology limitations.
            </p>
            ...
            <p className="about-believe-p">
               *Not all of these roles are necessary in all products. Wisely selection is needed depending on needs and sectors.
            </p>
